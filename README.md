...
As of now only **Beta & Alpha** versions will be available on the Github page. This means that if you wish to download the latest **stable** release you must do so from our **[Modrinth](https://modrinth.com/plugin/anti-admin) or [Spigot](https://www.spigotmc.org/resources/anti-admin.109941/)**
## Installation
